...
#ifndef SQ_NATIVE_DEBUGHOOK
#define SQ_NATIVE_DEBUGHOOK 1
#endif

#if SQ_NATIVE_DEBUGHOOK
typedef void (*SQDEBUGHOOK)(HSQUIRRELVM vm, SQChar eventType, const SQChar *sourceLocation, SQInteger line, const SQChar *funcName);
#endif
...
#if SQ_NATIVE_DEBUGHOOK
SQUIRREL_API SQDEBUGHOOK sq_getdebughook(HSQUIRRELVM v);
SQUIRREL_API void sq_setdebughook(HSQUIRRELVM v, SQDEBUGHOOK hook);
#else
